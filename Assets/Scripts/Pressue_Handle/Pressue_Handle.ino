...
// Pure FSR sensor controller (No haptic motor load on USB 5V rail)
...
void setup() {
  Serial.begin(115200); // 115200 baud (matching BroomFlightController default)
  Serial.println(F("--- DUAL FSR MODE: THRUST (A0) & ALTITUDE (A1) ---"));
}
